...
public class HandResult {
   ...
   * @return a list of strings representing the hand result, including the Yaku, scores, and formatted scores
   */
  public static List<String> computeHandResult(PlayerStats playerStats) {
    ...
    List<String> res = Arrays.asList(
      ...
      String.valueOf(result.getSnd().getFst()),
      String.valueOf(result.getSnd().getSnd()),
